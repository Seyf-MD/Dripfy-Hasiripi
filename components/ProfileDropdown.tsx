...
const ProfileDropdown: React.FC<ProfileDropdownProps> = ({ userName, userEmail, onLogout, onOpenSettings }) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 w-64 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-lg z-50 animate-fade-in-up origin-top-right">
                    ...
                    <ul className="py-2">
                        <li>
                            <button
                                ...
                                className="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors"
                            >
                                <UserCircle size={16} />
                        ...
                        <li>
                            <button
                                ...
                                className="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors mt-2 border-t border-neutral-200 dark:border-neutral-700"
                            >
                                <LogOut size={16} />
