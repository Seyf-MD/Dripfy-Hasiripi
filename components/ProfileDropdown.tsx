...
const ProfileDropdown: React.FC<ProfileDropdownProps> = ({ userName, userEmail, onLogout, onOpenSettings, isAdmin, onOpenLegalEditor }) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 w-72 ios-glass rounded-2xl shadow-2xl z-50 animate-fade-in-up origin-top-right border border-white/20 overflow-hidden backdrop-blur-xl">
