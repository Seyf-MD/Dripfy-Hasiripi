...
export const COLLECTION_FILE_MAP = {
  ...
  stakeholderInvitations: 'stakeholderInvitations.json',
  portalProfiles: 'portalProfiles.json',
  portalDocuments: 'portalDocuments.json',
  portalSupportRequests: 'portalSupportRequests.json',
  portalMessages: 'portalMessages.json',
  portalActivity: 'portalActivity.json',
